// js/men-casual-standard.js
// Interactions for Casual Standard page:
// - Lazy image loading
...
(function () {
  ...
  var ROOT = qs('#casual-grid') || document;
  var ROW = qs('#casual-grid .row', ROOT) || qs('.row', ROOT);
  ...
  function createPreview() {
    ...
    overlay.innerHTML = ''
      ...
      + '  <button id="casual-preview-close" aria-label="Close preview" style="position:absolute;right:12px;top:12px;background:transparent;border:0;font-size:22px;cursor:pointer;">✕</button>'
      + '  <img id="casual-preview-img" src="" alt="" />'
      + '  <div class="preview-body">'
      + '    <h3 id="casual-preview-title"></h3>'
      + '    <p id="casual-preview-text" class="meta"></p>'
      + '    <div style="margin-top:12px;display:flex;gap:8px;">'
      + '      <button id="casual-preview-order" class="btn btn-brown">Order this item</button>'
      + '      <button id="casual-preview-contact" class="btn btn-outline-brown">Contact Team</button>'
      + '    </div>'
      + '  </div>'
      + '</div>';
    ...
    qs('#casual-preview-close', overlay).addEventListener('click', closePreview);
  ...
  function openPreview(card) {
    ...
    var previewImg = qs('#casual-preview-img', overlay);
    var previewTitle = qs('#casual-preview-title', overlay);
    var previewText = qs('#casual-preview-text', overlay);
    var previewOrder = qs('#casual-preview-order', overlay);
    var previewContact = qs('#casual-preview-contact', overlay);
