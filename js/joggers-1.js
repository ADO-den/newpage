// js/men-joggers-1.js
// Interactions for Men Joggers page:
// - Lazy image loading
...
(function () {
  ...
  // Page elements
  var ROOT = qs('#joggers-grid') || document;
  var ROW = qs('#joggers-grid .row', ROOT) || qs('.row', ROOT);
  ...
  function createPreview() {
    ...
    overlay.innerHTML = ''
      ...
      + '  <button id="joggers-preview-close" aria-label="Close preview" style="position:absolute;right:12px;top:12px;background:transparent;border:0;font-size:22px;cursor:pointer;">✕</button>'
      + '  <img id="joggers-preview-img" src="" alt="" />'
      + '  <div class="preview-body">'
      + '    <h3 id="joggers-preview-title"></h3>'
      + '    <p id="joggers-preview-text" class="meta"></p>'
      + '    <div style="margin-top:12px;display:flex;gap:8px;">'
      + '      <button id="joggers-preview-order" class="btn btn-brown">Order this item</button>'
      + '      <button id="joggers-preview-contact" class="btn btn-outline-brown">Contact Team</button>'
      + '    </div>'
      + '  </div>'
      + '</div>';
    ...
    qs('#joggers-preview-close', overlay).addEventListener('click', closePreview);
  ...
  function openPreview(card) {
    ...
    var previewImg = qs('#joggers-preview-img', overlay);
    var previewTitle = qs('#joggers-preview-title', overlay);
    var previewText = qs('#joggers-preview-text', overlay);
    var previewOrder = qs('#joggers-preview-order', overlay);
    var previewContact = qs('#joggers-preview-contact', overlay);
