// js/men-jeans-1.js
// Interactions for Men Jeans page:
// - Lazy image loading
...
(function () {
  ...
  var ROOT = qs('#jeans-grid') || document;
  var ROW = qs('#jeans-grid .row', ROOT) || qs('.row', ROOT);
  ...
  function createPreview() {
    ...
    overlay.innerHTML = ''
      ...
      + '  <button id="jeans-preview-close" aria-label="Close preview" style="position:absolute;right:12px;top:12px;background:transparent;border:0;font-size:22px;cursor:pointer;">✕</button>'
      + '  <img id="jeans-preview-img" src="" alt="" />'
      + '  <div class="preview-body">'
      + '    <h3 id="jeans-preview-title"></h3>'
      + '    <p id="jeans-preview-text" class="meta"></p>'
      + '    <div style="margin-top:12px;display:flex;gap:8px;">'
      + '      <button id="jeans-preview-order" class="btn btn-brown">Order this item</button>'
      + '      <button id="jeans-preview-contact" class="btn btn-outline-brown">Contact Team</button>'
      + '    </div>'
      + '  </div>'
      + '</div>';
    ...
    qs('#jeans-preview-close', overlay).addEventListener('click', closePreview);
  ...
  function openPreview(card) {
    ...
    var previewImg = qs('#jeans-preview-img', overlay);
    var previewTitle = qs('#jeans-preview-title', overlay);
    var previewText = qs('#jeans-preview-text', overlay);
    var previewOrder = qs('#jeans-preview-order', overlay);
    var previewContact = qs('#jeans-preview-contact', overlay);
