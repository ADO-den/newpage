// js/men-tops.js
// Interactions for Men Tops page:
// - Lazy image loading
...
(function () {
  ...
  var ROOT = qs('#tops-grid') || document;
  var ROW = qs('#tops-grid .row', ROOT) || qs('.row', ROOT);
  ...
  function createPreview() {
    ...
    overlay.innerHTML = ''
      ...
      + '  <button id="tops-preview-close" aria-label="Close preview" style="position:absolute;right:12px;top:12px;background:transparent;border:0;font-size:22px;cursor:pointer;">✕</button>'
      + '  <img id="tops-preview-img" src="" alt="" />'
      + '  <div class="preview-body">'
      + '    <h3 id="tops-preview-title"></h3>'
      + '    <p id="tops-preview-text" class="meta"></p>'
      + '    <div style="margin-top:12px;display:flex;gap:8px;">'
      + '      <button id="tops-preview-order" class="btn btn-brown">Order this item</button>'
      + '      <button id="tops-preview-contact" class="btn btn-outline-brown">Contact Team</button>'
      + '    </div>'
      + '  </div>'
      + '</div>';
    ...
    qs('#tops-preview-close', overlay).addEventListener('click', closePreview);
  ...
  function openPreview(card) {
    ...
    var previewImg = qs('#tops-preview-img', overlay);
    var previewTitle = qs('#tops-preview-title', overlay);
    var previewText = qs('#tops-preview-text', overlay);
    var previewOrder = qs('#tops-preview-order', overlay);
    var previewContact = qs('#tops-preview-contact', overlay);
