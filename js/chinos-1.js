// js/men-chinos-1.js
// Lightweight interactions for Men Chinos page:
// - Lazy image loading
...
(function () {
  ...
  // Elements
  var ROOT = qs('#chinos-grid') || document;
  var ROW = qs('#chinos-grid .row', ROOT) || qs('.row', ROOT);
  ...
  function createPreview() {
    ...
    overlay.innerHTML = ''
      ...
      + '  <button id="chinos-preview-close" aria-label="Close preview" style="position:absolute;right:12px;top:12px;background:transparent;border:0;font-size:22px;cursor:pointer;">✕</button>'
      + '  <img id="chinos-preview-img" src="" alt="" />'
      + '  <div class="preview-body">'
      + '    <h3 id="chinos-preview-title"></h3>'
      + '    <p id="chinos-preview-text" class="meta"></p>'
      + '    <div style="margin-top:12px;display:flex;gap:8px;">'
      + '      <button id="chinos-preview-order" class="btn btn-brown">Order this item</button>'
      + '      <button id="chinos-preview-contact" class="btn btn-outline-brown">Contact Team</button>'
      + '    </div>'
      + '  </div>'
      + '</div>';
    ...
    qs('#chinos-preview-close', overlay).addEventListener('click', closePreview);
  ...
  function openPreview(card) {
    ...
    var previewImg = qs('#chinos-preview-img', overlay);
    var previewTitle = qs('#chinos-preview-title', overlay);
    var previewText = qs('#chinos-preview-text', overlay);
    var previewOrder = qs('#chinos-preview-order', overlay);
    var previewContact = qs('#chinos-preview-contact', overlay);
