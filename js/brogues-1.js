// js/men-brogues-1.js
// Interactions for Men Brogues page:
// - Lazy image loading
...
(function () {
  ...
  var ROOT = qs('#brogues-grid') || document;
  var ROW = qs('#brogues-grid .row', ROOT) || qs('.row', ROOT);
  ...
  function createPreview() {
    ...
    overlay.innerHTML = ''
      ...
      + '  <button id="brogues-preview-close" aria-label="Close preview" style="position:absolute;right:12px;top:12px;background:transparent;border:0;font-size:22px;cursor:pointer;">✕</button>'
      + '  <img id="brogues-preview-img" src="" alt="" />'
      + '  <div class="preview-body">'
      + '    <h3 id="brogues-preview-title"></h3>'
      + '    <p id="brogues-preview-text" class="meta"></p>'
      + '    <div style="margin-top:12px;display:flex;gap:8px;">'
      + '      <button id="brogues-preview-order" class="btn btn-brown">Order this item</button>'
      + '      <button id="brogues-preview-contact" class="btn btn-outline-brown">Contact Team</button>'
      + '    </div>'
      + '  </div>'
      + '</div>';
    ...
    qs('#brogues-preview-close', overlay).addEventListener('click', closePreview);
  ...
  function openPreview(card) {
    ...
    var previewImg = qs('#brogues-preview-img', overlay);
    var previewTitle = qs('#brogues-preview-title', overlay);
    var previewText = qs('#brogues-preview-text', overlay);
    var previewOrder = qs('#brogues-preview-order', overlay);
    var previewContact = qs('#brogues-preview-contact', overlay);
    ...
    previewContact.onclick = function () {
      openWhatsApp(DEFAULT_PHONE, 'Hello, I would like to ask about the "' + (title || 'brogue') + '".');
    };
