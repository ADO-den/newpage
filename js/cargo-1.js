// js/men-cargo-1.js
// Interactions for Men Cargo page:
// - Lazy image loading
...
(function () {
  ...
  var ROOT = qs('#cargo-grid') || document;
  var ROW = qs('#cargo-grid .row', ROOT) || qs('.row', ROOT);
  ...
  function createPreview() {
    ...
    overlay.innerHTML = ''
      ...
      + '  <button id="cargo-preview-close" aria-label="Close preview" style="position:absolute;right:12px;top:12px;background:transparent;border:0;font-size:22px;cursor:pointer;">✕</button>'
      + '  <img id="cargo-preview-img" src="" alt="" />'
      + '  <div class="preview-body">'
      + '    <h3 id="cargo-preview-title"></h3>'
      + '    <p id="cargo-preview-text" class="meta"></p>'
      + '    <div style="margin-top:12px;display:flex;gap:8px;">'
      + '      <button id="cargo-preview-order" class="btn btn-brown">Order this item</button>'
      + '      <button id="cargo-preview-contact" class="btn btn-outline-brown">Contact Team</button>'
      + '    </div>'
      + '  </div>'
      + '</div>';
    ...
    qs('#cargo-preview-close', overlay).addEventListener('click', closePreview);
  ...
  function openPreview(card) {
    ...
    var previewImg = qs('#cargo-preview-img', overlay);
    var previewTitle = qs('#cargo-preview-title', overlay);
    var previewText = qs('#cargo-preview-text', overlay);
    var previewOrder = qs('#cargo-preview-order', overlay);
    var previewContact = qs('#cargo-preview-contact', overlay);
