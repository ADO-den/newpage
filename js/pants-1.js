// js/trousers.js
// JK Fashion Empire - Trousers & Jeans page interactions
// - WhatsApp ordering with size/waist validation
...
(function () {
  ...
  /* ---------------------------
     ...
     - Buttons: .order-btn with optional data-phone
     - Card should include .card-title, .price, optional .size-select
  ----------------------------*/
  document.addEventListener('click', function (e) {
    ...
    // If a size/waist selector exists, require selection
    ...
    if (size) parts.push('Size/Waist: ' + size);
  ...
  /* ---------------------------
     Category filtering
     - Buttons with data-filter attribute
  ...
  /* ---------------------------
     ...
     - sorts grid columns by price or newest flag
  ----------------------------*/
  (function setupSort() {
