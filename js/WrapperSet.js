// js/men-wrapper.js
// JK Fashion Empire - Men's Wrapper Sets page interactions
// - WhatsApp ordering with size validation
// - Category filtering (data-filter)
// - Sort select (client-side by price/newest/price)
...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    var title = titleEl ? titleEl.textContent.trim() : 'Wrapper set';
